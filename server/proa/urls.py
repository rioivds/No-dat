...
urlpatterns = [
    ...
    # EDITADO POR MDO
    # Calificaciones:
    path('calificacioness/', views.calificacionesBase, name='calificaciones-base'),
    path('caliprimero/', views.caliPrimero, name='calificaciones-primero'),
    path('calisegundo/', views.caliSegundo, name='calificaciones-segundo'),
    path('calitercero/', views.caliTercero, name='calificaciones-tercero'),
    path('calicuarto/', views.caliCuarto, name='calificaciones-cuarto'),
