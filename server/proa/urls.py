...
urlpatterns = [
    ...
    path('materias/importar_materias/', views_materia.importar_materias, name='importar_materias'),
    path('calificaciones/importar_calificaciones/', views_calificaciones.importar_calificaciones, name='importar_calificaciones'),
